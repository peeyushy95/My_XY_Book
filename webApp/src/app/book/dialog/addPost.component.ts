...
@Component({
  ...
  export class AddPostDialog {
    ...
    constructor(public _bookService:BookService,public dialogRef: MdDialogRef<AddPostDialog>,@Inject(MD_DIALOG_DATA) public data: any) {
    }
